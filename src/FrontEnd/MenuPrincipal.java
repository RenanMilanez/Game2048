...
public class MenuPrincipal {
    ...
    public static void exibirMenu(){
         while (true) {
            ...
            Console.println(AMARELO + "   ⣿⣿" + BRANCO + "     2 - CARREGAR JOGO     " + AMARELO + "⣿⣿" + RESET);
            Console.println(AMARELO + "   ⣿⣿" + BRANCO + "      3 - COMO JOGAR       " + AMARELO + "⣿⣿" + RESET);
            Console.println(AMARELO + "   ⣿⣿" + BRANCO + "     4 - SAIR DO JOGO      " + AMARELO + "⣿⣿" + RESET);
            Console.println(AMARELO + "   ⣿⣿                           ⣿⣿" + RESET);
            Console.println(AMARELO + "   ⣿⣿                           ⣿⣿" + RESET);
            Console.println(AMARELO + "   ⣿⣿⣤⣤⣤⣤⣤⣤⣤⣤⣤⣤⣤⣤⣤⣤⣤⣤⣤⣤⣤⣤⣤⣤⣤⣤⣤⣤⣤⣿⣿" + RESET);
            Console.println(AMARELO + "   ⠛⠛⠛⠛⠛⠛⠛⠛⠛⠛⠛⠛⠛⠛⠛⠛⠛⠛⠛⠛⠛⠛⠛⠛⠛⠛⠛⠛⠛⠛⠛" + RESET);
                switch (Console.getTecla()) {
                    ...
                    Load.carregarJogo("AutoSave.VelKoz");
                    break;
